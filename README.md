...
Сборщик легко поддерживать в актуальном состоянии, что упрощает дальнейшие миграции, а при помощи конфигурации webpack можно расширять сборку различными плагинами. Отсутствие CLI интерфейса делает его не зависимым от глобального окружения - необходим только Node.js.
...
Fe Starter Bricks полностью бесплатен и открыт (MIT). Если проект помогает вам экономить время — буду рад любой поддержке:

- ⭐ Поставьте звезду на GitHub

### Готовые решения на базе Fe Starter Bricks

Если вам нужны уже собранные и оформленные шаблоны / блоки, а не только сборщик:

- Платные UI-киты и готовые компоненты 
- Шаблоны лендингов, многостраничников, email-рассылок (MJML) 
- Индивидуальная доработка сборщика под ваш проект / компанию (TypeScript-миграция, интеграции, оптимизация) — от 40 000 ₽  

Пишите в issues / [telegram](https://t.me/evgenystaroverov) — обсудим задачу.

## Support the Project & Additional Resources

Fe Starter Bricks is and will always remain **completely free and open-source** (MIT license).  
If the project saves you time or makes your work easier — I'd be really grateful for any kind of support:

- ⭐ Star the repository on GitHub

### Ready-made Solutions Built on Fe Starter Bricks

If you're looking for pre-built, styled templates and blocks instead of just the build system:

- Paid UI kits and ready-made components  
- Professional templates (landing pages, multi-page websites, MJML email campaigns)  
- Custom setup / adaptation of the builder for your project or company (TypeScript migration, integrations, performance optimization) — starting from 500 $  

Feel free to open an issue or message me directly in [Telegram](https://t.me/evgenystaroverov) — happy to discuss your needs!
